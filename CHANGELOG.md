...
- A multi-worker deployment could fail to start once its cached TERCET ZIPs were
  past `PC2NUTS_DB_CACHE_TTL_DAYS`. Every worker loads data at startup from the
